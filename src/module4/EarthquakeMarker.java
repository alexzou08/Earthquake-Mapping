...
public abstract class EarthquakeMarker extends SimplePointMarker
{
	...
	//EarthquakeMarkers have an ¡°age¡± property, and the value of this property can be:
	// ¡°Past Hour¡±, ¡°Past Day¡±, ¡°Past Week¡± or ¡°Past Month¡±.
	private void timeMarker(PGraphics pg, float x, float y) {
		String p = "Past Day";
		if(this.getAge().equalsIgnoreCase(p)) {
			pg.line(x, y, x+10, y+10);
			pg.line(x, y+10, x+10, y);
		}
	}
